...
* Method braces and other braces (`if`/`else`/`switch`/`while` etc.) always open on a new line after the statement and close on a new line.
...
Use VVDocumenter - https://github.com/onevcat/VVDocumenter-Xcode
